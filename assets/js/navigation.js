/* global magazinScreenReaderText */
	...
	document.addEventListener( 'DOMContentLoaded', function() {
		...
		if ( handheld.length > 0 ) {
			[].forEach.call( handheld[0].querySelectorAll( '.menu-item-has-children > a, .page_item_has_children > a' ), function( anchor ) {
				...
				btnSpan.appendChild( document.createTextNode( magazinScreenReaderText.expand ) );
				...
				btn.addEventListener( 'click', function() {
					...
					btnSpan.appendChild( document.createTextNode( expanded ? magazinScreenReaderText.collapse : magazinScreenReaderText.expand ) );
