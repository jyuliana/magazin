<?php
/**
 * magazin WooCommerce Adjacent Products Class
 *
 * @package  magazin
 * @since    2.4.3
 */
...
if ( ! class_exists( 'magazin_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The magazin WooCommerce Adjacent Products Class
	 */
	class magazin_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'magazin_woocommerce_adjacent_query_args', $args ) );
