...
if ( ! class_exists( 'magazin_Plugin_Install' ) ) :
	/**
	 * The magazin plugin install class
	 */
	class magazin_Plugin_Install {
		...
		public function plugin_install_scripts( $hook_suffix ) {
			...
			wp_enqueue_script( 'magazin-plugin-install', get_template_directory_uri() . '/assets/js/admin/plugin-install' . $suffix . '.js', array( 'jquery', 'updates' ), $magazin_version, 'all' );

			wp_enqueue_style( 'magazin-plugin-install', get_template_directory_uri() . '/assets/css/admin/plugin-install.css', array(), $magazin_version, 'all' );
		}
			...
			if ( current_user_can( 'install_plugins' ) && current_user_can( 'activate_plugins' ) ) {
				if ( is_plugin_active( $plugin_slug . '/' . $plugin_file ) ) {
					...
					$button = array(
						...
						'url'     => '#',
						'classes' => array( 'magazin-button', 'disabled' ),
					);
...
return new magazin_Plugin_Install();
